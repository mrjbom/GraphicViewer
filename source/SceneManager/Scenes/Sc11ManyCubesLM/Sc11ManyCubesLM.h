#ifndef SC11MANYCUBESLM_H
#define SC11MANYCUBESLM_H
...
#include "ui_Sc11ManyCubesLMOptionsForm.h"

class Sc11ManyCubesLM : public SceneManager
{
private:
    QOpenGLFunctions_4_5_Core* glFunctions = nullptr;
    Ui::Sc11ManyCubesLMOptionsForm* uiOptionsForm = nullptr;
...
public:
    Sc11ManyCubesLM(QOpenGLContext* openGLContext);
    ~Sc11ManyCubesLM();
